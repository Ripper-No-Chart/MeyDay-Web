    ...
    <main>
        ...
        <section class="container mt-3">
            <form action="#" method="POST" class="form-group d-flex justify-content-center p-2 row">
                ...
                <div class="col-6 mt-2"><input type="text" class="form-control" name="campo" /></div>
                <div class="col-12 mt-2"><input type="submit" class="form-control btn-primary" name="buscar" id="buscar" value="Buscar" /></div>                
            </form>
        </section>
